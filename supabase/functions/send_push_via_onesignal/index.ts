...
serve(async (req) => {
  ...
  try {
    ...
    console.log('🔑 Loading OneSignal credentials from environment...');
    ...
    console.log('🔐 Using OneSignal auth scheme:', 'Key *****' + apiKey.slice(-6));
    ...
    // Send notification using REST API key with "Key" prefix
